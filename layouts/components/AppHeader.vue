<template>
    <div class="flex items-center justify-between p-4 app-header">
        ...
        <nav class="hidden md:flex flex-grow justify-center space-x-4">
            <a href="#" class="text-xl hover:text-blue-600">{{ $t('header.projects') }}</a>
            <a href="#" class="text-xl hover:text-blue-600">{{ $t('header.aboutMe') }}</a>
            <a href="#" class="text-xl hover:text-blue-600">{{ $t('header.contact') }}</a>
        </nav>
